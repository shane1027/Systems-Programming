...
int main(int argc, char *argv[]) {
    ...
    printf("about to try delete n1 recursively..\n");
    n1 = node_delete(n1, true);
    assert(n1 == NULL);
    printf("Deleted node n1 recursively \n");
    ...
    printf("Deleted node n0 \n");
    assert(n0 == NULL);
    n1 = node_delete(n1, false);
    printf("Deleted node n1 \n");
    assert(n1 == NULL);
